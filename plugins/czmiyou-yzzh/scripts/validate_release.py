...
EXPECTED_FILES = {
    ...
    'runtime/yzzh_local/launcher.py', 'runtime/yzzh_local/web/launch.js', 'runtime/yzzh_local/media.py', 'runtime/yzzh_local/original_media.py', 'runtime/yzzh_local/workflow_approval.py',
