...
CLIENT = ["__init__.py", "account.py", "settings.py", "provider.py", "launcher.py", "web/launch.js", "media.py", "original_media.py", "runtime.py", "app.py", "mcp.py", "original.py", "original_worker.py", "offline_audio.py", "web/index.html", "web/app.js", "web/style.css", "web/portal.js"]
